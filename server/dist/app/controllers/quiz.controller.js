...
const getQuizPreview = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield QuizService.getQuizPreview(req);
        return res.status(200).json(response);
    }
    catch (err) {
        return res.status(500).json(err);
...
const getQuizForExam = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield QuizService.getQuizForExam(req);
        return res.status(200).json(response);
    }
    catch (err) {
        return res.status(500).json(err);
...
const getDiscoveryQuizzes = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield QuizService.getDiscoveryQuizzes(req);
        return res.status(200).json(response);
    }
    catch (err) {
        return res.status(500).json(err);
...
const deleteQuiz = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield QuizService.deleteQuiz(req);
        return res.status(200).json(response);
    }
    catch (err) {
