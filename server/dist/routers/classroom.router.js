...
classroomRouter.get('/getClassroomDetail', auth_middleware_1.authUserMiddleware, ClassroomController.getClassroomDetail);
classroomRouter.patch('/enrollInClassroom', auth_middleware_1.authUserMiddleware, ClassroomController.enrollInClassroom);
